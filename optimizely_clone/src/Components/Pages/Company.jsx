  ...
  return (
    <div>
      ...
      <div className={style.company}>
        ...
        <div>
          <img
            src="https://www.optimizely.com/globalassets/02.-global-images/customer-logos/filippa-k-wien.png?width=200&height=130"
            alt=""
          />
        </div>
      </div>
      ...
      <div className={style.customerbtn}>
        <Button>See our customers stories</Button>
      </div>
    </div>
  );
};
